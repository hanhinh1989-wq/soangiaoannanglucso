...
<div class="main-header">
    ...
    <p>Tác giả: Hà Thị Nhinh - Trường PTDTBT Tiểu học Trung Thịnh - ĐT: 098 3922 190</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hà Thị Nhinh - Trường PTDTBT Tiểu học Trung Thịnh - ĐT: 098 3922 190</div>", unsafe_allow_html=True)
